...
test = datagen2.flow_from_directory('/mnt/Documents/Project⁄Thesis/ResNet152V2/tomato/val')

model = tf.keras.models.load_model('/mnt/Documents/Project⁄Thesis/ResNet152V2/ResNet152V2.h5')
# model.summary()


classes = os.listdir('/mnt/Documents/Project⁄Thesis/ResNet152V2/tomato/val/')

plt.figure(figsize=(18,28))

for i in enumerate(classes):
    pic = os.listdir('/mnt/Documents/Project⁄Thesis/ResNet152V2/tomato/val/'+i[1])
    pic = pic[np.random.randint(len(pic)-1)]
    image = Image.open('/mnt/Documents/Project⁄Thesis/ResNet152V2/tomato/val/'+i[1]+'/'+pic)
